  ...
  return (
    ...
    >
      <div className="relative h-full w-full overflow-hidden">
        <h3 className="py-2 md:py-12 text-2xl font-bold tracking-tighter md:text-5xl lg:text-7xl duration-300 group-hover:-translate-y-full">
          {title}
        </h3>

        <div className="absolute top-0 left-0 flex h-full flex-col justify-center translate-y-full duration-300 group-hover:translate-y-0">
